...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void resetSalary(Integer employeeId) {
        ...
        self.updateDepartment(employeeId, 14); // self вводим для того, чтобы вызвать новый объект,
        // и тогда к нему будут применены все собственные аннотации метода updateDepartment, иначе они будут проигнорированы
    }
